...
<script type="text/javascript">
	function exitSys() {
		...
		if (flag) {
			...
			//window.top.close();
			//window.location.href = "/servlet/eixtSys";
			if (window != top) 
			top.location.href = "${pageContext.request.contextPath}/servlet/exitSys";
			//top.location.href = location.href; 
			//window.location.href = "${pageContext.request.contextPath}/servlet/exitSys";
		}
							...
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								<tr>
									...
									<td width="155" valign="bottom"
										...
										<c:url value="/servlet/eixtSys" var="exitUrl">											
										</c:url>
										
										<a href="${exitUrl }"
											>退出系统</a> </font> -->
											
											<button type="button" id="eixtSys" name="eixtSys" value="退出登录"
							class="button_add" onclick="exitSys()">退出登录</button>
