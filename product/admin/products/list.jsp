						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<c:forEach items="${books }" var="book">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<!-- <a href="${pageContext.request.contextPath }/admin/products/edit.jsp?id=${book.id }&name=${book.name }&price=${book.price }&pnum=${book.pnum }&category=${book.category }&img_url=${book.img_url }&description=${book.description}"> -->
										
										<c:url value="/admin/products/edit.jsp" var = "editUrl">
											 <c:param name="id" value="${book.id }"/>
											  <c:param name="name" value="${book.name }"/>
											  <c:param name="price" value="${book.price }"/>
											  <c:param name="pnum" value="${book.pnum }"/>
											  <c:param name="category" value="${book.category}"/>
											  <c:param name="img_url" value="${book.img_url }"/>
									...
									<td align="center" style="HEIGHT: 22px" width="7%">
									<c:url value="/servlet/delBookServlet" var="delBookUrl">
